...
r1=topicdb.topic.map_reduce(topic_mapper, topic_reducer, out=SON([("replace", "account_day_all")] ) , query={'updatetime':{'$gte':begin_time,'$lte':end_time}})
r2=topicdb.topic.map_reduce(topic_mapper, topic_reducer, out=SON([("replace", "account_day_24")] ) , query={'updatetime':{'$gte':begin_time,'$lte':end_time}, 'teamid':24})
r3=topicdb.topic.map_reduce(topic_mapper, topic_reducer, out=SON([("replace", "account_day_241")] ) , query={'updatetime':{'$gte':begin_time,'$lte':end_time}, 'teamid':241})
...
#savetotopicdb(dayallfilename, "normalstatistic", cur)
savetotopicdb(dayallfilename, "post_message_statistics", cur)
savetotopicdb(dayallfilename, "circle_comment_statistics", cur)
savetotopicdb(dayallfilename, "post_praise_statistics", cur)
savetotopicdb(dayallfilename, "angel_user_circle_statistics", cur)
savetotopicdb(impfilename, "im_message_statistics", cur)
savetotopicdb(dayallfilename, "feedback_circle_statistics", cur)
